namespace MVC5Customer.Models
{
	public static class RepositoryHelper
	{
		...
		public static View_CustomerDataNumRepository GetView_CustomerDataNumRepository()
		{
			var repository = new View_CustomerDataNumRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static View_CustomerDataNumRepository GetView_CustomerDataNumRepository(IUnitOfWork unitOfWork)
		{
			var repository = new View_CustomerDataNumRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
